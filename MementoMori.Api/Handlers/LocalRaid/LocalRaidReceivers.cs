...
{
    public LocalRaidJoinRoomReceiver(OrtegaMagicOnionClient ortegaMagicOnionClient, Action<string> log, CancellationToken cancellationToken) 
        : base(ortegaMagicOnionClient, log, cancellationToken)
    {
    }
...
public class LocalRaidCreateRoomReceiver : LocalRaidBaseReceiver
{
    ...
    public LocalRaidCreateRoomReceiver(OrtegaMagicOnionClient ortegaMagicOnionClient, Action<string> log, int waitSeconds, CancellationToken cancellationToken) 
        : base(ortegaMagicOnionClient, log, cancellationToken)
    {
