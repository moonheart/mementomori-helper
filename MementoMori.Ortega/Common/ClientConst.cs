...
//
// 			public static readonly Dictionary<CharacterRarityFlags, Color> CharacterFrameColorDictionary;
//
// 			public static readonly Dictionary<CharacterRarityFlags, Color> CharacterWideFrameColorDictionary;
//
// 			public static readonly Dictionary<EquipmentRarityFlags, Color> EquipmentFrameColorDictionary;
//
// 			public static readonly Dictionary<ItemRarityFlags, Color> ItemFrameColorDictionary = new()
// 			{
// 				[ItemRarityFlags.None] = 0xFF7A858A.ToColor(),
// 				[ItemRarityFlags.D] = 0xFFBE9279.ToColor(),
// 				[ItemRarityFlags.C] = 0xFFFFFFFF.ToColor(),
// 				[ItemRarityFlags.B] = 0xFFFDC057.ToColor(),
// 				[ItemRarityFlags.A] = 0xFFB667FF.ToColor(),
// 				[ItemRarityFlags.S] = 0xFFF55555.ToColor(),
// 				[ItemRarityFlags.R] = 0xFFCBD7FD.ToColor(),
// 				[ItemRarityFlags.SR] = 0xFFFFD47A.ToColor(),
// 				[ItemRarityFlags.SSR] = 0xFFAE68ED.ToColor(),
// 				[ItemRarityFlags.UR] = 0xFFE35566.ToColor(),
// 				[ItemRarityFlags.LR] = 0xFFFFFFFF.ToColor(),
// 			};
//
// 			public static readonly Dictionary<IconPlateType, Color> PlateColorDictionary;
//
// 			public static readonly Dictionary<LegendLeagueClassType, Color> PlayerFrameColorDictionary;
//
// 			public static readonly Dictionary<EquipmentRarityFlags, Color> SphereFrameColorDictionary;
// 		}
// 	}
// }
