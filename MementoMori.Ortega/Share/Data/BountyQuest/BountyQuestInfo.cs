...
namespace MementoMori.Ortega.Share.Data.BountyQuest
{
	...
	public class BountyQuestInfo
	{
		...
		public long BountyQuestLimitTime
		{
			get;
			set;
		}
		...
		public long BountyQuestClearTime
		{
			get;
			set;
		}
		...
		public long InitialRequireCurrencyForQuick
		{
			get;
			set;
		}

		public BountyQuestInfo()
		{
		}
	}
}
