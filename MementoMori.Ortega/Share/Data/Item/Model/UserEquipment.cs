...
namespace MementoMori.Ortega.Share.Data.Item.Model
{
	...
	public class UserEquipment : IUserItem, IReadOnlyEquipment, IAdditionalParameter
	{
		...
		public UserEquipment(long itemId, long itemCount, bool hasParameter, string guid, string characterGuid, long additionalParameterHealth, long additionalParameterMuscle, long additionalParameterEnergy, long additionalParameterIntelligence, long sphereUnlockedCount, long sphereId1, long sphereId2, long sphereId3, long sphereId4, long legendSacredTreasureExp, long legendSacredTreasureLv, long matchlessSacredTreasureExp, long matchlessSacredTreasureLv, long reinforcementLv)
		{
			this.ItemType = (ItemType)((ulong)4L);
			this.ItemId = itemId;
			this.ItemCount = itemCount;
		...
		public long AdditionalParameterHealth
		{
			get;
			set;
		}

		public long AdditionalParameterIntelligence
		{
			get;
			set;
		}

		public long AdditionalParameterMuscle
		{
			get;
			set;
		}

		public long AdditionalParameterEnergy
		{
			get;
			set;
		}

		public long SphereId1
		{
			get;
			set;
		}

		public long SphereId2
		{
			get;
			set;
		}

		public long SphereId3
		{
			get;
			set;
		}

		public long SphereId4
		{
			get;
			set;
		}

		public long SphereUnlockedCount
		{
			get;
			set;
		}

		public long LegendSacredTreasureExp
		{
			get;
			set;
		}

		public long LegendSacredTreasureLv
		{
			get;
			set;
		}

		public long MatchlessSacredTreasureExp
		{
			get;
			set;
		}

		public long MatchlessSacredTreasureLv
		{
			get;
			set;
		}

		public long ReinforcementLv
		{
			get;
			set;
		}
