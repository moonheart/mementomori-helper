...
namespace MementoMori.Ortega.Share.Master.Data
{
	...
	public class PlayerRankMB : MasterBookBase
	{
		...
		public long CriticalDamageEnhanceBonus
		{
			get;
		}
		...
		public long DamageEnhanceBonus
		{
			get;
		}
		...
		public long DefensePenetrationBonus
		{
			get;
		}
		...
		public int HitDirectPercentBonus
		{
			get;
		}
		...
		public int LevelLinkMemberMaxCount
		{
			get;
		}
		...
		public PlayerRankMB(long id, bool? isIgnore, string memo, long rank, long requiredTotalExp, string startTimeFixJST, long attackPowerBonus, long hpBonus, long hpPercentBonus, long defensePenetrationBonus, long damageEnhanceBonus, int criticalBonus, int hitBonus, int debuffHitBonus, int speedBonus, long criticalDamageEnhanceBonus, int hpDrainBonus, int damageReflectBonus, int hitDirectPercentBonus, int levelLinkMemberMaxCount)
