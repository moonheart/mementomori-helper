...
namespace MementoMori.Ortega.Share.Master.Data
{
	...
	public class TimeServerMB : MasterBookBase
	{
		...
		public TimeServerType TimeServerType
		{
			get;
			set;
		}
		...
		[PropertyOrder(6)]
		[Description("国コードリスト")]
		public IReadOnlyList<string> CountryCodeList
		{
			get;
		}
		...
		[PropertyOrder(4)]
		public LanguageType DefaultVoiceLanguageType
		{
			get;
		}
		...
		public TimeServerMB(long id, bool? isIgnore, string memo, string name, TimeServerType timeServerType, string differenceDateTimeFromUtc, LanguageType defaultLanguageType, LanguageType defaultVoiceLanguageType, string displayNameKey, IReadOnlyList<string> countryCodeList)
		...
		[PropertyOrder(2)]
		public string DifferenceDateTimeFromUtc
		{
			get;
		}
