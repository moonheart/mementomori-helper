...
namespace MementoMori.Ortega.Share.Master.Data
{
	...
	public class CharacterCollectionLevelMB : MasterBookBase
	{
		...
		[PropertyOrder(4)]
		[Nest(false, 0)]
		public IReadOnlyList<BaseParameterChangeInfo> BaseParameterChangeInfos
		{
			get;
		}
		...
		[PropertyOrder(6)]
		public int CharacterRarityBonus
		{
			get;
		}
		...
		public CharacterCollectionLevelMB(long id, bool? isIgnore, string memo, IReadOnlyList<BaseParameterChangeInfo> baseParameterChangeInfos, IReadOnlyList<BattleParameterChangeInfo> battleParameterChangeInfos, int characterRarityBonus, CharacterRarityFlags characterRarityFlags, int collectionId, int collectionLevel)
