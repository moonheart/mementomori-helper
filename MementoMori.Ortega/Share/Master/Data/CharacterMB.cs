...
namespace MementoMori.Ortega.Share.Master.Data
{
	...
	public class CharacterMB : MasterBookBase, IHasJstStartEndTime
	{
		...
		[Nest(false, 0)]
		[PropertyOrder(8)]
		public BaseParameter BaseParameterCoefficient
		{
			get;
		}
		...
		[PropertyOrder(9)]
		public int BaseParameterGrossCoefficient
		{
			get;
		}
		...
		public long RequireFragmentCount
		{
			get;
		}
		...
		public CharacterMB(long id, bool? isIgnore, string memo, IReadOnlyList<long> activeSkillIds, BaseParameter baseParameterCoefficient, int baseParameterGrossCoefficient, CharacterType characterType, ElementType elementType, BattleParameter initialBattleParameter, ItemRarityFlags itemRarityFlags, JobFlags jobFlags, string nameKey, string name2Key, long normalSkillId, IReadOnlyList<long> passiveSkillIds, CharacterRarityFlags rarityFlags, long requireFragmentCount, string endTimeFixJST, string startTimeFixJST)
