...
namespace MementoMori.Ortega.Share.Master.Data
{
	...
	public class BountyQuestEventMB : MasterBookBase, IHasStartEndTime
	{
		...
		public IReadOnlyList<BountyQuestEventTargetItemInfo> TargetItemList
		{
			get;
		}
		...
		[PropertyOrder(6)]
		[Nest(false, 0)]
		public IReadOnlyList<BountyQuestEventTargetQuestTypeInfo> TargetQuestTypeList
		{
			get;
		}

		[SerializationConstructor]
		public BountyQuestEventMB(long id, bool? isIgnore, string memo, string eventNameKey, string eventDescriptionKey, string startTime, string endTime, int multipleNumber, IReadOnlyList<BountyQuestEventTargetQuestTypeInfo> targetQuestTypeList, IReadOnlyList<BountyQuestEventTargetItemInfo> targetItemList)
