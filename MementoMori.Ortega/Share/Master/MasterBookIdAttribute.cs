namespace MementoMori.Ortega.Share.Master
{
	...
	public class MasterBookIdAttribute : Attribute
	{
		public Type Type
		{
			get;
		...
		public MasterBookIdAttribute(Type type)
		{
			Type = type;
			/*
An exception occurred when decompiling this method (0600333E)

ICSharpCode.Decompiler.DecompilerException: Error decompiling System.Void Ortega.Share.Master.MasterBookIdAttribute::.ctor(System.Type)

 ---> System.Exception: Basic block has to end with unconditional control flow. 
{
	Block_0:
	call:void(MacUtilities::.ctor, ldloc:MasterBookIdAttribute[exp:MacUtilities](this))
	callreadonlysetter:Type(MasterBookIdAttribute::get_Type, ldloc:MasterBookIdAttribute(this), ldloc:Type(type))
}
